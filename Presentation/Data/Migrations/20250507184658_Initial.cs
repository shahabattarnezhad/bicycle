        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_AspNetUsers_VerifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BicycleStatus = table.Column<int>(type: "int", nullable: false),
                    BicycleType = table.Column<int>(type: "int", nullable: false),
                    SerialNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CurrentStationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BicycleGps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BicycleGps_Bicycles_BicycleId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "70f7c142-4ba0-43bb-966a-d4b8f7ea4eb6", null, "Customer", "CUSTOMER" },
                    { "b09cf6dc-a3aa-4cdd-b1e9-f22a1d5d3149", null, "Admin", "ADMIN" },
                    { "cbf2fd6c-60ba-4bb7-a066-b04cb9b5ea85", null, "Employee", "EMPLOYEE" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "b09cf6dc-a3aa-4cdd-b1e9-f22a1d5d3149", "43362001-32cd-482e-a7c0-e4d2e528c94e", "AppUserRole" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BicycleGps_BicycleId",
                table: "BicycleGps",
                column: "BicycleId");

            migrationBuilder.CreateIndex(
                name: "IX_BicycleGps_Timestamp",
                table: "BicycleGps",
                column: "Timestamp");
